...
func (server *Server) servePage(writer http.ResponseWriter, view string) {
	...
	_, _ = io.WriteString(writer, `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Oberth Dashboard</title><link rel="stylesheet" href="/assets/app.css"><link rel="stylesheet" href="/assets/theme.css"></head><body data-version="`+html.EscapeString(server.version)+`"><div class="app"><aside class="side" id="side"><div class="side-head"><button class="brand" data-route="/runs"><span class="mark">[▲]</span><span class="brand-name">oberth</span></button><button class="railbtn" data-action="toggle-rail" title="Collapse sidebar" aria-label="Collapse sidebar" aria-expanded="true" aria-controls="side"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15 6l-6 6 6 6"/></svg></button></div><nav class="nav2" aria-label="Primary"><a data-route="/runs" title="runs" aria-label="runs"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 12h4l3-8 4 16 3-8h4"/></svg><span>runs</span></a><a data-route="/repos" title="repos" aria-label="repos"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="6" cy="6" r="2.2"/><circle cx="6" cy="18" r="2.2"/><circle cx="18" cy="8" r="2.2"/><path d="M6 8.2v7.6"/><path d="M18 10.2V11a3 3 0 0 1-3 3H9"/></svg><span>repos</span></a><a data-route="/issues" title="issues" aria-label="issues"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7.5v5"/><path d="M12 16.2h.01"/></svg><span>issues</span></a><a data-route="/status" title="status" aria-label="status"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.5" y="4" width="19" height="6.5" rx="2"/><rect x="2.5" y="13.5" width="19" height="6.5" rx="2"/><path d="M6.5 7.25h.01M6.5 16.75h.01"/></svg><span>status</span></a></nav><div class="side-foot"><div class="top-status" aria-label="System status"><span class="status-segment backend" title="loading" aria-label="loading"><span id="connLed" class="led" aria-hidden="true"></span><span id="connText" class="conn-text">checking</span></span><span id="versionStatus" class="version-mode unknown" role="status" aria-live="polite" hidden><span id="verLabel" class="ver"></span></span></div><div class="side-actions"><button class="sidebtn" data-action="toggle-theme" title="Toggle theme" aria-label="Toggle theme"><span class="sidebtn-ico ico-light"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/></svg></span><span class="sidebtn-ico ico-dark"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M20 14.5A8.5 8.5 0 0 1 9.5 4a8.5 8.5 0 1 0 10.5 10.5z"/></svg></span><span class="sidebtn-label lbl-light">Light</span><span class="sidebtn-label lbl-dark">Dark</span></button><button class="sidebtn" data-action="refresh" title="Refresh" aria-label="Refresh"><span class="sidebtn-ico"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 12a9 9 0 1 1-2.6-6.4"/><path d="M21 3v6h-6"/></svg></span><span class="sidebtn-label">Refresh</span></button><button class="sidebtn" data-action="clear-token" title="Log out" aria-label="Log out"><span class="sidebtn-ico"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><path d="M10 17l5-5-5-5"/><path d="M15 12H3"/></svg></span><span class="sidebtn-label">Log out</span></button></div></div></aside><div class="work"><header class="top"><div class="ask"><input id="jump" type="search" autocomplete="off" placeholder="filter branches, or type repos / issues / status"><span class="kb">/</span></div></header><main id="app" class="main" data-view="`+view+`"><noscript><p>The Oberth dashboard requires JavaScript. The JSON views remain available at /api/runs, /api/repos, /api/issues, and /api/status with a bearer token.</p></noscript></main></div></div><dialog id="issueDialog" class="dlg" aria-labelledby="issueDialogTitle"><div class="dlg-shell"><header class="dlg-head"><h2 id="issueDialogTitle">Issue</h2><span id="issueDialogMeta" class="meta"></span><button class="dlg-close" data-action="close-issue" aria-label="Close issue details">×</button></header><div id="issueDialogContent" class="dlg-body"></div></div></dialog><script src="/assets/app.js" defer></script></body></html>`)
}
