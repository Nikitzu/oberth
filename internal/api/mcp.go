...
func toolDefinitions() []map[string]any {
	...
	return []map[string]any{
		...
		tool("skills", "List the skills Oberth ships for working with it: triage, pipeline authoring, fragments and the credentialed tier. Read one with skill_get before guessing at Oberth's behaviour.", object(map[string]any{})),
		tool("skill_get", "Return one Oberth skill body by name, as markdown.", object(map[string]any{"name": stringProperty("Skill name as reported by skills")}, "name")),
