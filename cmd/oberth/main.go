...
const usageCommands = "audit, init, validate, install, upgrade, serve, upstream, repo, schedules, fragments, artifacts, runs, run, repos, issues, status, uplink, access, secretstore, or version"
