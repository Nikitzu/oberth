...
const usageCommands = "audit, init, validate, install, upgrade, serve, upstream, repo, fragments, artifacts, schedules, skills, runs, run, log, repos, issues, status, uplink, access, secretstore, or version"
